...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center bg-[#25D366] font-medium text-white shadow-sm shadow-[#25D366]/25 transition-all duration-150 hover:bg-[#1ebe57] hover:shadow-md active:scale-[0.98] ${sizes[size]}`}
    >
